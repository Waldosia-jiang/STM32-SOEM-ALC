...
boolean                 EcatError = (boolean)FALSE;
...
void ecx_pusherror(ecx_contextt *context, const ec_errort *Ec)
{
   ...
   context->elist->Error[context->elist->head].Signal = (boolean)TRUE;
   context->elist->head++;
   ...
   *(context->ecaterror) = (boolean)TRUE;
}
...
boolean ecx_poperror(ecx_contextt *context, ec_errort *Ec)
{
   ...
   *Ec = context->elist->Error[context->elist->tail];
   context->elist->Error[context->elist->tail].Signal = (boolean)FALSE;
   if (notEmpty)
   {
      context->elist->tail++;
      if (context->elist->tail > EC_MAXELIST)
   ...
   {
      *(context->ecaterror) = (boolean)FALSE;
   }
   return notEmpty;
}
...
{
   return (boolean)(context->elist->head != context->elist->tail);
}
